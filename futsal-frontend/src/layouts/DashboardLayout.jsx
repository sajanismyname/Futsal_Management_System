    ...
    <div className="min-h-screen flex" style={{ backgroundColor: '#f4f4f7' }}>
      ...
      >
        ...
        <div className="h-16 flex items-center gap-3 px-5"
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[11px]" style={{ color: 'rgba(255,255,255,0.35)' }}>Owner Panel</p>
          </div>
        ...
        <nav className="flex-1 px-3 space-y-0.5 overflow-y-auto">
          {ownerNav.map(({ to, label, end, icon }) => (
            <NavLink
              key={to}
              to={to}
              end={end}
      ...
      <div className="flex-1 flex flex-col min-w-0 md:ml-60">
        ...
        >
          ...
          <span className="text-white font-semibold text-sm">FutsalMgmt</span>
        </header>
